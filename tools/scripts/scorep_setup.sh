...
#----- end PDT install
      ...
      # <llvm/ADT/Triple.h> (the LLVM <17 location). Modern LLVM (ROCm
      # 7.x ships LLVM 19+) moved Triple to <llvm/TargetParser/Triple.h>
      # and removed the legacy header. The compute-node Warewulf image
      # was patched to install the system `llvm-dev` package (Ubuntu
