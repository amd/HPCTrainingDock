...
- ROCm versions available: 6.3.0, 6.3.1, 6.3.2, 6.3.3, 6.3.4, 6.4.0, 6.4.1, 6.4.2, 6.4.3, 7.0.0, 7.0.1, 7.0.2, 7.1.0, 7.1.0.lua.bak-pre-hipblaslt-autoload, 7.1.1, 7.1.1.lua.bak-pre-hipblaslt-autoload, 7.2.0, 7.2.0.lua.bak-pre-hipblaslt-autoload, 7.2.1, 7.2.2, 7.2.2.lua.bak-pre-hipblaslt-autoload, 7.2.3, 7.2.3.lua.bak-20260513, 7.2.3.lua.bak-pre-hipblaslt-autoload, afar-22.1.0, afar-22.2.0, therock-23.1.0, therock-23.2.1
- gcc: 11.4.0
...
*Generated on 2026-05-18 04:30:02 CDT.*

<!-- AAC6_STATUS_METADATA — machine-readable facts for the next-run diff. Do not edit by hand.
os=Ubuntu 22.04.5 LTS
kernel=6.5.0-45-generic
rocm_default=7.2.0
rocm_versions=6.3.0,6.3.1,6.3.2,6.3.3,6.3.4,6.4.0,6.4.1,6.4.2,6.4.3,7.0.0,7.0.1,7.0.2,7.1.0,7.1.0.lua.bak-pre-hipblaslt-autoload,7.1.1,7.1.1.lua.bak-pre-hipblaslt-autoload,7.2.0,7.2.0.lua.bak-pre-hipblaslt-autoload,7.2.1,7.2.2,7.2.2.lua.bak-pre-hipblaslt-autoload,7.2.3,7.2.3.lua.bak-20260513,7.2.3.lua.bak-pre-hipblaslt-autoload,afar-22.1.0,afar-22.2.0,therock-23.1.0,therock-23.2.1
