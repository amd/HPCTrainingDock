...
wget -q https://github.com/ROCm/rocm-libraries/archive/refs/tags/${ROCM_BRANCH}.tar.gz -O rocm-libraries-${ROCM_BRANCH}.tgz
...
tar -xzf rocm-libraries-${ROCM_BRANCH}.tgz 
...
export HIPBLAS_COMMON_DIR="$(readlink -f  rocm-libraries-$ROCM_BRANCH/projects/hipblas-common)"
export HIPBLAS_DIR="$(readlink -f  rocm-libraries-$ROCM_BRANCH/projects/hipblas)"
export HIPFFT_DIR="$(readlink -f rocm-libraries-$ROCM_BRANCH/projects/hipfft)"
export HIPSOLVER_DIR="$(readlink -f rocm-libraries-$ROCM_BRANCH/projects/hipsolver)"
export HIPSPARSE_DIR="$(readlink -f rocm-libraries-$ROCM_BRANCH/projects/hipsparse)"
