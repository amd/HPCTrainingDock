...
# The - option suppresses tabs
   cat <<-EOF | ${SUDO} tee ${MODULE_PATH}/${GCC_VERSION}.lua
	...
	setenv("FC", "/usr/bin/gfortran-${GCC_VERSION}")
        setenv("OMPI_CC", pathJoin(base, "/usr/bin/gcc-${GCC_VERSION}"))
        setenv("OMPI_CXX", pathJoin(base, "/usr/bin/g++-${GCC_VERSION}"))
        setenv("OMPI_FC", pathJoin(base, "/usr/bin/gfortran-${GCC_VERSION}"))
...
cat <<-EOF | ${SUDO} tee ${MODULE_PATH}/base.lua
	...
	setenv("FC", "/usr/bin/gfortran")
        setenv("OMPI_CC", pathJoin(base, "/usr/bin/gcc"))
        setenv("OMPI_CXX", pathJoin(base, "/usr/bin/g++"))
        setenv("OMPI_FC", pathJoin(base, "/usr/bin/gfortran"))
	append_path("INCLUDE_PATH", "/usr/include")
...
do
   ...
   cat <<-EOF | ${SUDO} tee ${MODULE_PATH}/${CLANG_VERSION}.lua
	...
	setenv("FC", "/usr/bin/flang-${CLANG_VERSION}")
        setenv("OMPI_CC", pathJoin(base, "/usr/bin/clang-${CLANG_VERSION}"))
        setenv("OMPI_CXX", pathJoin(base, "/usr/bin/clang++-${CLANG_VERSION}n"))
        setenv("OMPI_FC", pathJoin(base, "/usr/bin/flang-${CLANG_VERSION}"))
	append_path("INCLUDE_PATH", "/usr/include")
...
cat <<-EOF | ${SUDO} tee ${MODULE_PATH}/base.lua
	...
	setenv("FC", "/usr/bin/flang")
        setenv("OMPI_CC", pathJoin(base, "/usr/bin/clang"))
        setenv("OMPI_CXX", pathJoin(base, "/usr/bin/clang++"))
        setenv("OMPI_FC", pathJoin(base, "/usr/bin/flang"))
	append_path("INCLUDE_PATH", "/usr/include")
