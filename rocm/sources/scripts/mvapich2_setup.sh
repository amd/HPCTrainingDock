...
mkdir -p /opt/rocmplus-SCRIPT_ROCM_VERSION
mv /opt/mvapich2 /opt/rocmplus-SCRIPT_ROCM_VERSION/mvapich2
...
cat > ${MODULE_PATH}/2.3.7.lua <<-EOF
	...
	local base = "/opt/rocmplus-SCRIPT_ROCM_VERSION/mvapich2/gdr/2.3.7/no-mcast/no-openacc/rocm5.1/mofed5.0/mpirun/gnu10.3.1"
