...
local topDir="/opt/rocmplus-ROCM_VERSION/omniperf-1.0.10"
local binDir="/opt/rocmplus-ROCM_VERSION/omniperf-1.0.10/bin"
local shareDir="/opt/rocmplus-ROCM_VERSION/omniperf-1.0.10/share"
local pythonDeps="/opt/rocmplus-ROCM_VERSION/omniperf-1.0.10/python-libs"
local roofline="/opt/rocmplus-ROCM_VERSION/omniperf-1.0.10/bin/utils/rooflines/roofline-ubuntu20_04-mi200-rocm5"
